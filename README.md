...
* Tampilan ringkas dan langsung pada inti data.
* Ringan saat berjalan lancar di Termux maupun Linux

### 🛠️ Menggunakan module
* Python 3.13
* Requests
* rich 

### 🚀 Cara Penggunaan
1. git clone https://github.com/RyotaXD/getcontack
2. cd getcontack
3. chmod +x getcontack
4. ./getcontack

---
Dibuat untuk tujuan edukasi dan pembelajaran. Jangan disalahgunakan!
